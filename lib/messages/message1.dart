...
class ChatScreen1 extends StatelessWidget {
  final List<Message> messages = [
    Message(
        "Hello, FashionFiesta! I'm looking for an elegant party dress. Can you help me?",
        false,
        "18:00"),
    Message(
        "Of course, we have many options for party dresses that you might like. Is there a specific color you prefer?",
        true,
        "18:02"),
    Message("I prefer blue. Can you show me some options?", false, "18:04"),
    Message(
        "Certainly! I'll send you photos of some blue dresses we have available.",
        true,
        "18:06"),
    Message("", true, "18:06",
        imageUrl:
            "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQg965dIOxp_QuPZj84rdukf_U6PO3G_xBClg&s"),
  ];
