...
class ChatScreen2 extends StatelessWidget {
  final List<Message> messages = [
    Message(
        "Hello, Ahmet! I'm looking for an elegant party suit. Can you help me?",
        false,
        "18:00"),
    Message(
        "Of course, we have many options for party suits that you might like. Is there a specific color you prefer?",
        true,
        "18:02"),
    Message("I prefer black. Can you show me some options?", false, "18:04"),
    Message(
        "Certainly! I'll send you photos of some black suits we have available.",
        true,
        "18:06"),
    Message("", true, "18:06",
        imageUrl:
            "https://www.studiosuits.com/cdn/shop/files/allblackwooltuxedosuitiilk.jpg?v=1725089829"),
  ];
        ...
        title: Row(
          children: [
            Stack(
              children: [
                CircleAvatar(
                  backgroundImage: AssetImage('assets/p4.jpeg'),
                ),
                Positioned(
